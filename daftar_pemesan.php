        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Daftar Pemesan</span>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                    ...
                                    <td>
                                        <a href="pemesanan-view.php?id_pemesanan=<?php echo $isi['id_pemesanan'] ; ?>" class="btn btn-sm btn-primary">Lihat </a>
                                        <a href="pemesanan-edit.php?id_pemesanan=<?php echo $isi['id_pemesanan'] ; ?>" class="btn btn-sm btn-warning">Edit </a>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapusnya?')" href="pemesanan-delete.php?id_pemesanan=<?php echo $isi['id_pemesanan'] ; ?>" class="btn btn-sm btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                    }
