...
<?php
  ...
  $query = $connection->query("SELECT max(kode_pemesanan) FROM pemesanan");

	$kode = mysqli_fetch_array($query);

	if($kode){
		$nilai = substr($kode[0], 1);
		$code = (int) $nilai;

		//tambahkan sebanyak + 1
		$code = $code + 1;
		$auto_kode = "F" .str_pad($code, 4, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "E0001";
	}
?>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="halaman_petugas.php">
          <img src="images/logo.svg" alt="logo" />
        </a>
        <a class="navbar-brand brand-logo-mini" href="halaman_petugas.php">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="panel-heading">Tambah Jadwal Pemberangkatan
                    ...
                    <a href="halaman_penumpang.php" class="btn btn-xs-primary btn-default pull-right">Kembali </a><br><br>
                  </div>

                  <form class="forms-sample" method="post" action="proses_input-tiket.php">
                    <div class="form-group">
                      <label>Kode Pemesanan</label>
                      <input type="text" readonly="readonly" name="kode_pemesanan" value=" <?php echo $auto_kode; ?> " class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tempat_pemesanan" class="form-control">
                    </div>
                    <div class="form-group">
                                <label>Tujuan</label>
                                <div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden"  value="Not Verify" name="valid" class="form-control">
                    </div>
