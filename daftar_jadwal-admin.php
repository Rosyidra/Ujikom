                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="panel-heading">Daftar Jadwal
                          ...
                          <a class="btn btn-xs-primary btn-default pull-right"></a>
                          <a class="btn btn-xs-primary btn-default pull-right"></a>
                          <a href="input_jadwal.php" class="btn btn-xs-primary btn-default pull-right">Tambah </a>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                    ...
                                    <td>
                                        <a href="jadwal-view.php?id_rute=<?php echo $isi['id_rute'] ; ?>" class="btn btn-sm btn-primary">Lihat </a>
                                        <a href="jadwal-edit.php?id_rute=<?php echo $isi['id_rute'] ; ?>" class="btn btn-sm btn-warning">Edit </a>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapusnya?')" href="jadwal-delete.php?id_rute=<?php echo $isi['id_rute'] ; ?>" class="btn btn-sm btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                    }
