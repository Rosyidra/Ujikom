        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <div class="panel-heading">Daftar Hak Akses
                          ...
                          <a class="btn btn-xs-primary btn-default pull-right"></a>
                          <a class="btn btn-xs-primary btn-default pull-right"></a>
                          <a href="input_hak_akses.php" class="btn btn-xs-primary btn-default pull-right">Tambah </a>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                    ...
                                    <td align="Right">
                                        <a href="hak-view.php?id=<?php echo $isi['id'] ; ?>" class="btn btn-sm btn-primary">Lihat </a>
                                        <a href="hak-edit.php?id=<?php echo $isi['id'] ; ?>" class="btn btn-sm btn-warning">Edit </a>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapusnya?')" href="hak-delete.php?id=<?php echo $isi['id'] ; ?>" class="btn btn-sm btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                    }
